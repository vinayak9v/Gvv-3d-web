      ...
      <section className="relative flex min-h-[70svh] flex-col items-center justify-center px-6 text-center">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="mx-auto text-lg leading-relaxed text-blue-200/70 md:text-xl">
            CBSE-mandated disclosure documents for Garima Vidhya Vihar — affiliation
            details, infrastructure and academic records — will be published here soon.
            In the meantime, see our{' '}
            <a href="/about/affiliation" className="text-[#FACC15] underline underline-offset-4 hover:text-white">
              CBSE Affiliation
            </a>{' '}
            page for affiliation code, school code and status.
          </p>
        </div>
      </section>
    </PageShell>
