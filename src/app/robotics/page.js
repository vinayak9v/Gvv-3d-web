...
export default function RoboticsPage() {
  ...
  return (
    <main ref={container} className="relative w-full bg-[#050b14] text-white overflow-hidden font-sans">
      ...
      {/* ... HERO, ABOUT ... */}
       <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-6 pt-28">
